...
async function currentlocation(req, res) {
  try{
    ...
    //console.log(req.connection);
     ...
     await fetch(`https://geolocation-db.com/json/a5f3c240-7310-11ed-8abc-5520d31fdee7`)
     .then(res => res.json())
     .then(async(datas) => {
      // console.log(datas);
...
async function currentaddress(req, res) {
  try{
    ...
    // const datass = await fetch(`https://geolocation-db.com/json/0f761a30-fe14-11e9-b59f-e53803842572`)
    // console.log(datass);
    //  .then(res => res.json())
    //  .then(async(datas) => {
    //    //return res.status(201).json({datas:datas});
